...
public class RemoveTask extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(Helper.validateManager(session)){
               ...
               out.println("<form action=\"ProRemoveTask\" class=\"w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin w3-round-xlarge\" method=\"POST\">\n" +
                    "<h4 class=\"w3-center\">Remove a Task</h4>\n" +
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RemoveTask.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
