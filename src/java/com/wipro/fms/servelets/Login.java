...
public class Login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {                                    
            ...
            UsersBean user = new UsersBean(username,password);            
            ...
            if(user!=null){
               ...
               response.sendRedirect("Welcome");
                ...
                out.print("<div class='container'><div class='alert alert-danger'>Invalid Username/Password Combination</div></div>");
            ...
            System.out.println("Error at : "+this.getClass()+" "+e);
            System.out.println("Error at : "+this.getClass()+" "+e.getMessage());
            PrintWriter out = response.getWriter();
            out.print("Error at : "+this.getClass()+" "+e.getMessage());
        }
    }
